...
import GOJO.modules.sql.feds_sql as sql
from GOJO import (
    LOGGER,
    OWNER_ID,
    DRAGONS,
...
from GOJO.modules.helper_funcs.alternate import send_message
from GOJO.modules.helper_funcs.chat_status import is_user_admin
from GOJO.modules.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
from GOJO.modules.helper_funcs.string_handling import markdown_parser
...
# Hello bot owner, I spended for feds many hours of my life, Please don't remove this if you still respect MrYacha and peaktogoo,AyraHikari and Yun too
# Federation by MrYacha 2018-2019
# Federation rework by Mizukito Akito 2019
# Federation update v2 by yun 2019
# Time spended on feds = 10h by #MrYacha
# Time spended on reworking on the whole feds = 22+ hours by @peaktogoo
# Time spended on updating version to v2 = 26+ hours by @mr_nack_nack
...
def new_fed(update: Update, context: CallbackContext):
    ...
    if not fednam == "":
        ...
        try:
            ...
            LOGGER.warning("Cannot send a message to LOG_CHANNEL")
    else:
        update.effective_message.reply_text(
