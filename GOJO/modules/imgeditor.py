...
# By @TroJanzHEX
from GOJO.Extras.ImageEditor.edit_1 import (  # pylint:disable=import-error
    black_white,
    box_blur,
    bright,
    g_blur,
...
from GOJO.Extras.ImageEditor.edit_2 import (  # pylint:disable=import-error
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from GOJO.Extras.ImageEditor.edit_3 import (  # pylint:disable=import-error
    black_border,
    blue_border,
    green_border,
    red_border,
)
from GOJO.Extras.ImageEditor.edit_4 import (  # pylint:disable=import-error
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from GOJO.Extras.ImageEditor.edit_5 import (  # pylint:disable=import-error
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴄᴏɴᴛʀᴏʟs", callback_data="contrast"
                        ),
                    ],
                    [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="Ʀᴇᴍᴏᴠᴇ ʙᴀᴄᴋɢʀᴏᴜɴᴅ", callback_data="removebg"
                        ),
                    ],
                    [
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text="ᴇᴅʜᴇ ᴄᴜʀᴠᴇᴅ", callback_data="cur_ved"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
