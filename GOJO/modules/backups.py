...
import GOJO.modules.sql.notes_sql as sql
from GOJO import dispatcher, LOGGER, OWNER_ID
from GOJO.vars import LOG_CHANNEL, SUPPORT_CHAT
from GOJO.__main__ import DATA_IMPORT
...
import GOJO.modules.sql_2.rules_sql as rulessql

# from Shikimori.modules.sql import warns_sql as warnssql
import GOJO.modules.sql_2.blacklist_sql as blacklistsql
from GOJO.modules.sql import disable_sql as disabledsql

# from Shikimori.modules.sql import cust_filters_sql as filtersql
# import Shikimori.modules.sql.welcome_sql as welcsql
import GOJO.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Shikimori_{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Shikimori_{}.backup".format(chat_id), "rb"),
    ...
    os.remove("Shikimori_{}.backup".format(chat_id))  # Cleaning file
