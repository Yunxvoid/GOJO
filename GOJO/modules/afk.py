...
def afk(update, context):
    ...
    try:
        GOJO = update.message.reply_video("https://telegra.ph/file/bfe511a9f3b1bf225c144.mp4", caption ="`{}` is now AFK! Sayonara!".format(fname), parse_mode=ParseMode.MARKDOWN)
        time.sleep(50)
        try:
            GOJO.delete()
        except BadRequest:
