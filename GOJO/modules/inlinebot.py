...
from GOJO.utils.inlinehelper import *
from GOJO.utils.pluginhelpers import fetch, json_prettify
from GOJO import pbot
from GOJO.vars import API_WEATHER, TIME_API_KEY, SUPPORT_CHAT, BOT_USERNAME
        ...
        if text.split()[0] == "alive":
            ...
            async with aiohttp.ClientSession() as session:
                response_api_zero = await session.get(
                    sample_url.format(input_str, API_WEATHER)
                )
