...
@GOJOcallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@GOJOcallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@GOJOcallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@GOJOcmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
